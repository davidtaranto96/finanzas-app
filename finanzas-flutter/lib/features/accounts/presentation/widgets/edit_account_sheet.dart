...
const _accountTypeIcons = <String, IconData>{
  'cash': Icons.payments_rounded,
  'bank': Icons.account_balance_rounded,
...
void showEditAccountSheet(BuildContext context, WidgetRef ref, dom.Account account) {
  ...
  String selectedType = account.type.name; // 'cash', 'bank', 'credit', 'savings', 'investment'
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                  children: _accountTypeLabels.entries.map((entry) {
                    final isSelected = entry.key == selectedType;
                    final icon = _accountTypeIcons[entry.key]!;
                    return GestureDetector(
                      onTap: () => setState(() => selectedType = entry.key),
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: isSelected
                              ? Border.all(color: AppTheme.colorTransfer, width: 1.5)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(entry.value,
                                style: TextStyle(
                                  color: isSelected ? AppTheme.colorTransfer : Colors.white54,
                                  fontSize: 13,
                ...
                TextField(
                  ...
                  style: const TextStyle(color: Colors.white),
                  decoration: InputDecoration(
                    labelText: isCredit ? 'Gastos del periodo' : 'Saldo actual',
                    prefixText: r'$ ',
                    labelStyle: const TextStyle(color: AppTheme.colorTransfer),
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(16)),
                  ),
                ...
                // ── Credit card fields (only when type is credit) ──
                if (isCredit) ...[
                  const SizedBox(height: 16),
                  Row(
                    children: [
                  ...
                  child: FilledButton(
                    onPressed: () async {
                      ...
                      final creditLimit = creditLimitCtrl.text.isNotEmpty
                          ...
                          : null;
                      final debt = isCredit ? parseFormattedAmount(debtCtrl.text) : null;
                      ...
                      await ref.read(accountServiceProvider).updateAccount(
                        ...
                        clearClosingDay: !isCredit || (closingDayCtrl.text.isEmpty && account.closingDay != null),
                        clearDueDay: !isCredit || (dueDayCtrl.text.isEmpty && account.dueDay != null),
                        creditLimit: isCredit ? creditLimit : null,
                        clearCreditLimit: !isCredit || (creditLimitCtrl.text.isEmpty && account.creditLimit != null),
